...
public class InstructorManager implements InstructorService {
    ...
    public void showInstructors() {
        ...
        System.out.printf("%-16s \033[33m %-15s  %-15s \033[0m %-30s  %-15s  %-12s  \n", "Instructor Code", "First Name", "Last Name", "Email", "Phone Number", "Certificates");
        System.out.printf("%-16s  %-15s  %-15s  %-30s  %-15s  %-12s \n", "---------------", "-------------", "-------------", "-----------------------------", "---------------", "-----------");
        for (Instructor w : instructorList) {
            System.out.printf("%-16s \033[33m %-15s  %-15s \033[0m %-30s  %-15s  %-12s \n", w.getId(), w.getFirstName(), w.getLastName(), w.getEmail(), w.getPhoneNumber(), w.getCertificates());
        }
        System.out.println();
    }
